...
/*async function runDBConnection() {
    try {
        ...
        collection = database.collection("Cat"); // Replace "your_collection_name" with your actual collection name

        console.log("MongoDB connected and collection selected:", collection.namespace);
    } catch (ex) {
